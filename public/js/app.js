...
},{"./components/accounts/SelectAccount":5,"./components/employees/CreateEmployee":6,"./components/employees/EditEmployee":7,"./components/employees/EmployeesTable":8,"./components/users/Settings":9,"./components/visits/CreateVisit":10,"./components/visits/UpdateVisit":11,"./components/visits/VisitsTable":12,"./filters/dateTimeFormat":13,"vue":3}],5:[function(require,module,exports){
'use strict';
...
module.exports = Vue.extend({
    ...
    methods: {
        ...
        resetSuccessState: function resetSuccessState() {
            this.success = false;
        },
...
module.exports = Vue.extend({
    ...
    methods: {
        updateVisitor: function updateVisitor() {
            var vm = this;
        ...
        createVisit: function createVisit(e) {
            e.preventDefault();
            this.submitting = true;
            var vm = this;
...
module.exports = Vue.extend({
    ...
    ready: function ready() {
        $.getJSON('/api/accounts/' + accountID + '/visits/' + visit, function (visit) {
    ...
    methods: {
        ...
        updateVisit: function updateVisit(e) {
            e.preventDefault();
            this.submitting = true;
            var vm = this;
            ...
            $.ajax({
                url: '/api/accounts/' + accountID + '/visitations/' + visit,
                type: 'put',
                data: data,
                error: function (errors) {
                    if (errors.responseJSON.status_code !== 422) {
...
module.exports = Vue.extend({
    ...
    methods: {
        removeVisitor: function removeVisitor(visitor) {
        ...
        checkin: function checkin(index, visitor) {
            ...
            $.ajax({
                ...
                method: 'put',
                data: data,
                success: function success(visitor) {
        ...
        checkout: function checkout(index, visitor) {
            var date = moment().format('DD/MM/YYYY');
...
},{"moment":1,"vue":3}],13:[function(require,module,exports){
'use strict';
