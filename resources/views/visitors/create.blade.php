                    ...
                    <div class="panel-body">
                        <form action="#" class="form-horizontal group-border hover-striped">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10 col-md-10">
                                    <input type="text" class="form-control datetime-picker" placeholder="dd-mm-yyyy - hh:mm" autofocus="autofocus" name="expected_arrival | dateTimeFormat", v-model="expected_arrival" v-else>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10 col-md-10">
                                    <input type="text" class="form-control datetime-picker" placeholder="dd-mm-yyyy - hh:mm" autofocus="autofocus" name="expected_departure | dateTimeFormat", v-model="expected_departure" v-else>
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-2">
                                    ...
                                    <template v-else>
                                        <button class="btn btn-primary ml15" type="submit" @click="createVisit($event)">Create Visit</button>
                                    </template>
                                </div>
                            </div>
                        </form>
