...
use App\Api\Documents\Folders\Requests\ShowFolderRequest;
use App\Api\Documents\Folders\Requests\StoreFolderRequest;
use App\Api\Documents\Folders\Requests\UpdateFolderRequest;
...
class FolderController extends Controller
{
    ...
    public function show(ShowFolderRequest $request, Account $account, Document $document, Folder $folder)
    {
        return $this->response()->item($folder, new FolderTransformer());
    }

    public function update(UpdateFolderRequest $request, Account $account, Document $document, Folder $folder)
    {
    ...
    public function delete(ShowFolderRequest $request, Account $account, Document $document, Folder $folder)
    {
